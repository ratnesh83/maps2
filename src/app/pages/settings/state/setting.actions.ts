...
export const actionTypes = {
    ...
    APP_GET_CATEGORIES_EDIT: 'APP_GET_CATEGORIES_EDIT',
    APP_GET_CATEGORIES_EDIT_SUCCESS: 'APP_GET_CATEGORIES_EDIT_SUCCESS'
};
...
export class FollowCompany implements Action {
