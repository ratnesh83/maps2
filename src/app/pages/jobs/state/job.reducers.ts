...
export const job: ActionReducer<any> = (state = initialState, action: Action) => {
    switch (action.type) {
        ...
        case 'ADD_THIS_JOB':
            return Object.assign({}, state, { activeJob: action.payload, error: null });

        case 'ADD_THIS_JOB_SUCCESS':
            return Object.assign({}, state, { addJobSuccess: action.payload, error: null });
        ...
        case 'APP_GETALL_JOB':
            return Object.assign({}, state, { createJob: null, error: null });
        ...
        case 'EDIT_THIS_JOB':
            return Object.assign({}, state, { editJobProcess: true, error: null });

        case 'EDIT_JOB_SUCCESS':
            return Object.assign({}, state, { editJobSuccess: action.payload, error: null });

        case 'CREATE_JOB':
            return Object.assign({}, state, { createJob: null, error: null });

        case 'CREATE_JOB_SUCCESS':
            return Object.assign({}, state, { createJob: true, error: null });
        ...
        case 'NEW_JOB_DATA':
            return Object.assign({}, state, { showJobData: action.payload, error: null });
        ...
        case 'APPROVE_JOB_SUCCESS':
            return Object.assign({}, state, { approveJobSuccess: action.payload, error: null });
